...
namespace boost {
inline std::size_t hash_value(const blank&) { return 0; }
} // namespace boost
...
struct matrix4 : public item, public eigen_base<Eigen::Matrix4d> {
  ...
  public:
    ...
    enum tag_t {
        IDENTITY,
        AFFINE_WO_SCALE,
        AFFINE_W_UNIFORM_SCALE,
        AFFINE_W_NONUNIFORM_SCALE,
        OTHER
    };
    tag_t tag;
...
struct function_item : public implicit_item {
    ...
    virtual double projected_length() const = 0;
...
struct functor_item : public function_item {
    ...
    functor_item(double length, double projected_length, std::function<Eigen::Matrix4d(double u)> fn, const IfcUtil::IfcBaseInterface* instance = nullptr) : function_item(instance),
                                                                                                                                    length_(length),
    ...
    double projected_length() const override { return projected_length_; }
...
struct piecewise_function : public function_item {
    ...
    double projected_length() const override;
...
struct gradient_function : public function_item {
    ...
    virtual double projected_length() const override;
